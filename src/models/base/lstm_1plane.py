"""
LSTM-based model for 1-plane flow sequence prediction.
Processes 3-channel input (1 plane × 3 fields: u,v,w) for spatio-temporal prediction.
"""
...
class LSTM1Plane(nn.Module):
    """
    LSTM-based encoder-decoder for 1-plane flow prediction.
    Processes 3-channel input (1 plane × 3 fields: u,v,w) and predicts future states.
    """
    ...
    def __init__(
        ...
        num_channels=3,  # 1 plane × 3 fields (u,v,w) = 3 channels
        hidden_dims=None,
        kernel_sizes=None,
        num_layers=3,
        bias=True,
        **kwargs,
        ...
        Args:
            ...
            num_channels: Number of input channels (3 for 1-plane)
        ...
        # Input projection - expand channels for LSTM processing
    ...
    def forward(self, x):
        """
        Args:
            x: (B, T, C, H, W) input sequence where C = 3
        Returns:
...
def LSTM1PlaneAuto(**kwargs):
    """Factory function for LSTM 1-plane model."""
    return LSTM1Plane(**kwargs)
